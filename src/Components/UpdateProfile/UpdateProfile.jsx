...
const UpdateProfile = () => {
 ...
 const {user,UserUpdateProfile} = useContext(AuthContex)
  ...
  return (
    <div className="container mx-auto border mt-8 rounded-lg font-poppins flex items-center justify-evenly">
...
<form className="border p-8 rounded-lg mx-auto">
  Name
...
<button className="btn btn-accent text-white mt-4">Update profile</button>
